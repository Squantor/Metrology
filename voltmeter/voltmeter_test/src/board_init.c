...
void board_init(void)
{
    ...
    Chip_GPIO_SetPinDIROutput(LPC_GPIO, MCP355X_CE_PORT, MCP355X_CE_PIN);
    Chip_GPIO_SetPinDIROutput(LPC_GPIO, MCP355X_SCK_PORT, MCP355X_SCK_PIN);
    Chip_GPIO_SetPinDIRInput(LPC_GPIO, MCP355X_SDO_PORT, MCP355X_SDO_PIN);
